<div class="text-center text-[#f9f3e6] twokay-font-freshman uppercase">
  ...
  <div class="flex gap-4 flex-col sm:flex-row max-w-xs sm:max-w-none mx-auto justify-center">
    ...
    <a tabindex="0" role="link" class="border-double border-8 rounded xtwokay-border-blue twokay-bg-blue px-3 pt-3 pb-2 block sm:block-inline sm:px-8 md:px-12 text-[#f9f3e6] text-lg tracking-widest" href="mailto:emilyharden@techlahoma.org?subject=200OK%20Sponsorship%20Options">SPONSOR US</a>
  </div>
</div>
